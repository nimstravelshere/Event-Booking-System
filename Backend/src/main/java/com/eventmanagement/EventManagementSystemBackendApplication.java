...
public class EventManagementSystemBackendApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		...
		// this run method is presenet in org.springframework.boot.springapplication
		//sets up the application context, performs component scanning, does auto-configuration, and creates all the required beans.
	}
